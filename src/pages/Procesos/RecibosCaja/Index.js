        ...
        <div className="modal-body">
          <p className="text-center">
            <img
              ...
              src={(process.env.REACT_API_URL||'http://localhost:3002')+"/uploads/vouchers-Bill-cash-receipts/"+modalComprobante?.imagen}
            />
          </p>
        </div>
        ...
        <div className="modal-body">
          ...
          <p className="text-center">
            <img
              ...
              src={(process.env.REACT_API_URL||'http://localhost:3002')+"/uploads/vouchers-Bill-cash-receipts/"+modalComprobanteValidar?.imagen}
            />
          </p>
        </div>
